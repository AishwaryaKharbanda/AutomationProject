...
public class CatalogScreenPage {
	...
	//@FindBy(how=How.XPATH,using=".//*[@id='catalog_listings']/li[3]/div[1]/button")
	//WebElement wishlist_button3;
	...
	public CatalogScreenPage(WebDriver ldriver)
	{
		this.driver=ldriver;
	}
