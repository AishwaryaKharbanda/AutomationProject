...
public class HomePage {
 ...
 public void sign_up() {
  ...
  email_SignUp.sendKeys("kharbanda.aishwarya+test96859849@tftus.com");
 ...
 public Boolean existingEmailMessage() {
 ...
 public Boolean Blankdetails_SignUpUser() {
  if (firstName_blank.isDisplayed() && lastName_blankenter.isDisplayed() && enter_email.isDisplayed()
		  && length_pass.isDisplayed() && select_gender.isDisplayed()) {
   return true;
  } else {
  return false;
  }
