...
public class Login_incorrect_email {
...
Thread.sleep(3000);
		driver.findElement(By.xpath(email)).sendKeys("kharnda.aish@tftus.com");
	driver.findElement(By.xpath(password)).sendKeys("123456");
	driver.findElement(By.xpath(login)).click();
	Boolean wrongID = driver.findElement(By.xpath(".//*[@id='notify_bar']/div/div/p")).isDisplayed();
	Assert.assertTrue(wrongID);
	driver.close();
